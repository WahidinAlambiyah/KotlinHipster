...
class KotlinHipsterApp(private val env: Environment) {

    private val log = LoggerFactory.getLogger(javaClass)

    /**
     * Initializes KotlinHipster.
     *
    ...
    companion object {
        ...
        fun main(args: Array<String>) {
            val env = runApplication<KotlinHipsterApp>(*args) { DefaultProfileUtil.addDefaultProfile(this) }.environment
            logApplicationStartup(env)
        }

        @JvmStatic
        private fun logApplicationStartup(env: Environment) {
            val log = LoggerFactory.getLogger(KotlinHipsterApp::class.java)
